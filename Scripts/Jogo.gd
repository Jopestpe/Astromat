...
func PerderVida():
	...
	if Vida < 1:
		...
		animacoes.play("AcabouSurgir")
		$GerarAsteroide.stop()
		
func GirarAcabou():
	animacoes2.play("GirarAcabou")
		
func Errou():
	%Errou.play()

func Novamente():
	print("TESTE JOGAR 2222")
	animacoes3.play("IrParaJogo")
	
func EmCimaNovamente():
	animacoes.play("EmCimaNovamente")

func SaiuNovamente():
	animacoes.play("SaiuNovamente")
		
func TrocarParaJogo():
	print("trocar para jogo")
